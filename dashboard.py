...
def load_models():
    try:
        # Asumsikan file model berada di folder 'model/'
...
# =========================
    ...
    if uploaded_file and yolo_model and classifier:
        ...
        # =========================
            ...
            # PENAMBAHAN KONTEN TEKS HASIL KLASIFIKASI
